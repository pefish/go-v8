...
extern "C"
{
  ...
  {
    v8::Isolate *realIsolate = static_cast<v8::Isolate *>(isolate);
    realIsolate->Dispose();
  }
  ...
  IsolatePtr NewIsolate()
  {
    ...
    // v8::Locker locker(isolate); // 因为v8使用了tls优化性能，所以要使用Locker保证isolate始终绑定在同一个线程上
  ...
  void CHelloworld()
  {
    ...
    v8::Isolate *isolate = static_cast<v8::Isolate *>(NewIsolate());
